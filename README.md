...
```bash
git clone https://github.com/Csmolina/python-pizza-planet.git
```
...
- If you want to use the hot reload feature set FLASK_ENV before running the project (note that it's already implemented in MakeFile):
